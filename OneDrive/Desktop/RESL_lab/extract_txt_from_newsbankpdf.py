...
# We store articles in a working dictionary where title = article name and text = article content.
title_text_dict = {}
...
# print("HERE WE GO \n \n \n")
# print(peek)
# print(peek.split("OpenURL Link", maxsplit=1)[1].strip())

# oh, it's because we hv 2 instances of openurl link
